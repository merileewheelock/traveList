		...
		return(
			<div className="hiw-container-div text-center" id="howitworks">
				...
				<div className="row how-boxes-row">
					<div className="how-box col-lg-2 col-lg-offset-3">
						<div className="step-number"><h1>1</h1></div>
						<div className="step-icon col-xs-6 col-xs-offset-3 col-md-"><i class="fa fa-user-circle-o" aria-hidden="true"></i></div>
						<div className="steps">Create a user profile</div>
					</div>
					<div className="how-box col-lg-2">
						<div className="step-number"><h1>2</h1></div>
						<div className="step-icon col-xs-6 col-xs-offset-3"><i class="fa fa-question-circle-o" aria-hidden="true"></i></div>
						<div className="steps">Complete a short trip survey</div>
					</div>
					<div className="how-box col-lg-2">
						<div className="step-number"><h1>3</h1></div>
						<div className="step-icon col-xs-6 col-xs-offset-3"><i class="fa fa-check-circle-o" aria-hidden="true"></i></div>
